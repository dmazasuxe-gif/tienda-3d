...
export const StoreSettingsView: React.FC<StoreSettingsViewProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl text-slate-800">
      ...
      {/* SECTION 11 */}
      <div className="p-5 sm:p-6 rounded-3xl bg-white border border-orange-100 space-y-4 text-xs shadow-xs" id="section-whatsapp-templates">
        <div className="flex items-center justify-between">
          <h3 className="font-bold uppercase tracking-wider text-orange-800 text-xs flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="space-y-1.5">
            ...
            <textarea
              className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 text-slate-700 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors resize-y min-h-[120px]"
